...
function Footer() {
  ...
  <div className="flex xl:min-w-[1312px] max-xl:w-full max-xl:px-10 max-[600px]:px-4 justify-center">
    <div className="w-full mt-7 font-inter">
    <div className='flex justify-center w-full'>

      <div className="flex justify-between xl:min-w-[1312px] mb-10 items-center max-[700px]:flex-col max-[700px]:mt-10">
      ...
      <div className="flex justify-around mt-10 text-white">
        ...
        <div className='max-w-[30%]'>
          ...
          <p>Email: <a href="mailto:info@silverairporttaxis.com.au" className="hover:text-[#89bc21]">info@silverairporttaxis.com.au</a></p>
